<footer class="text-gray-600 dark:text-white dark:bg-black body-font pt-5 border-t border-dotted">
    <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
      ...
      <a href="{{route('help.index')}}" class="flex text-gray-500 dark:text-white hover:text-primary-color">
