<div class="bg-white shadow overflow-hidden sm:rounded-lg">
    <div class="p-3 bg-primary-color">
        <h1 class="text-white font-bold text-md">{{__('Resource')}}</h1>
    </div>
        ...
        <dl>
            <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                ...
                <dd class="flex items-center mt-1 text-sm font-bold text-gray-900 sm:mt-0 sm:col-span-2">
                    <a href="{{route('resources.show', $resource->id)}}" class="hover:text-primary-color">
                        {{$resource->name}}
                    </a>
                </dd>
            </div>
            <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                ...
                <dd class="flex items-center mt-1 text-sm font-normal text-gray-900 sm:mt-0 sm:col-span-2">
            ...
            <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                ...
                <dd class="flex items-center mt-1 text-sm font-bold text-gray-900 sm:mt-0 sm:col-span-2">
                    <a href="{{route('users.show',  $resource->creator->id)}}" class="hover:text-primary-color">
