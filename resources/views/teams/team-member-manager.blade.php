                ...
                <x-slot name="form">
                    <div class="col-span-6">
                        <div class="max-w-xl text-sm text-gray-600">
                            {{ __('Team Join Requests') }}
                        </div>
                        <div class="max-w-lg mt-3">
                            <x-tables.teams.team-requests :team="$team->id"/>
                        </div>
                    </div>
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        <x-jet-input type="email" placeholder="{{__('Email')}}" id="email" class="mt-1 w-full" wire:model.lazy="addTeamMemberForm.email" />
                        ...
                        <div class="col-span-6 lg:col-span-4">
                            ...
                            <div class="mt-1 border border-gray-200 rounded-lg cursor-pointer">
                                @foreach ($this->roles as $index => $role)
                                    <button type="button" class="px-4 py-3 inline-flex w-full rounded-lg focus:z-10 focus:outline-none focus:border-blue-300 focus:ring focus:ring-blue-200 {{ $index > 0 ? 'border-t border-gray-200 rounded-t-none' : '' }} {{ ! $loop->last ? 'rounded-b-none' : '' }}"
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center">
                                    @if (Gate::check('removeTeamMember', $team))
                                        ...
                                        <button class="cursor-pointer ml-6 text-sm text-red-700 focus:outline-none"
