...
<div class="border-t-8 border-gray-700 h-2"></div>
    ...
    <div class="flex justify-between">
        <h2 class="text-2xl font-bold mb-6 pb-2 tracking-wider uppercase">Customer Data</h2>
        <div>
    ...
    <template x-for="invoice in items" :key="invoice.id">
        <div class="flex -mx-1 py-2 border-b">
            ...
            <div class="px-1 w-20 text-right">
                <a href="#" class="text-red-700 hover:text-red-600 text-sm font-semibold" @click.prevent="deleteItem(invoice.id)">Delete</a>
            </div>
        </div>
    </template>
