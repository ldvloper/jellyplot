<div class="h-full shadow-md rounded-md bg-white dark:bg-gray-700 ">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-6 text-black text-xl p-3 bg-gray-50">
        <div>
    ...
    <div class="h-80 border-t overflow-auto no-scrollbar scrolling-touch">
        @forelse($tasks as $task)
            <div class="flex items-center text-gray-600 dark:text-gray-200 justify-between py-3 border-b-2 border-gray-100 dark:border-gray-800">
                <div class="flex items-center justify-start text-sm">
                     <a class="hover:text-primary-color mx-4" href="{{route('tasks.show', $task)}}" class="mx-4">
                    ...
                    <span title="{{__('Comments')}}" class="lg:ml-6 ml-2 flex items-center text-gray-400 dark:text-gray-300">
                         {{$task->comments->count()}}
                    ...
                    <span title="{{__('Total Days')}}" class="mx-4 flex items-center text-gray-400 dark:text-gray-300">
                     {{count($task->total_days)}}
                ...
                @if($task->end->lt(\Carbon\Carbon::now()))
