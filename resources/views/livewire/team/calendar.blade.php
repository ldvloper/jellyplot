 <div class="mb-4">
        <div class="max-h-96 shadow-lg rounded-2xl p-4 bg-white dark:bg-gray-700">
                    ...
                    <div class="-mx-2">
                        <table class="w-full dark:text-white">
                            ...
                            <tr>
                                ...
                                <td class="py-3 px-1  hover:text-blue-500 text-center cursor-pointer">
                                    3
                                ...
                                <td class="py-3 px-2 md:px-3 md:px-2  lg:px-3 hover:text-blue-500 text-center cursor-pointer">
                                    8
                                    <span class=" rounded-full h-2 w-2 bg-yellow-500 bottom-0 left-1/2 transform -translate-x-1/2">
                                                            </span>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="py-3 px-2 md:px-3  hover:text-blue-500  text-center cursor-pointer">
                                    25
                                    <span class=" rounded-full h-2 w-2 bg-red-500 bottom-0 left-1/2 transform -translate-x-1/2">
                                                            </span>
                                </td>
                                <td class="py-3 px-2 md:px-3  hover:text-blue-500 text-center cursor-pointer">
                                    26
