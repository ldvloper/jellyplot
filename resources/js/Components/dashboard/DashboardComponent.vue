<template>
    <main>
        <div class="pt-6 px-4">
            <div class="w-full grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-3 gap-4">
                <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 2xl:col-span-2">
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex-shrink-0">
                            <span class="text-2xl sm:text-3xl leading-none font-bold text-gray-900">{{user.name}}</span>
                            <h3 class="text-base font-normal text-gray-500">Your contributions</h3>
                        </div>
                    </div>
                    <div id="main-chart">
                        <user-contribution :user="this.user" :team="this.team"></user-contribution>
                    </div>
                </div>
                <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                    <div class="mb-4 flex items-center justify-between">
                        <div>
                            <h3 class="text-xl font-bold text-gray-900 mb-2 capitalize">Latest tasks</h3>
                            <span class="text-base font-normal text-gray-500">This is a list of your last created tasks</span>
                        </div>
                        <div class="flex-shrink-0">
                            <a :href="this.tasksRoute" class="text-sm font-medium text-cyan-600 hover:bg-gray-100 rounded-lg p-2">View All</a>
                        </div>
                    </div>
                    <latest-tasks></latest-tasks>
                </div>
            </div>
            <div class="mt-4 w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
...
<script>
import UserContribution from "./UserContributionComponent";
import LatestTasks from "./LatestTasksComponent";
